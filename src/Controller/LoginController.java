...
public class LoginController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        // Get the user's location and set the label text
       Locale currentLocale = Locale.getDefault();
       System.out.println(currentLocale);
        ZoneId zoneId = ZoneId.systemDefault();
        // Load the resource bundle for the user's locale
        ResourceBundle resources;
        if (currentLocale.equals(Locale.FRANCE)) {
            resources = ResourceBundle.getBundle("resources.login_fr");
        } else {
            resources = ResourceBundle.getBundle("resources.login_en");
        }
        usernameLabel.setText(resources.getString("login.username"));
        passwordLabel.setText(resources.getString("login.password"));
        ...
        loginButton.setOnAction(event -> {
            try {
                ...
                if (result.next()) {
                    ...
                    String alertText = resources.getString("login.errorMessage");
                    // login failed
